...
router.post('/',  roleMiddleware(['admin','restaurant_owner']), menuItemController.createMenuItem);
...
router.put('/:itemId', roleMiddleware(['admin','restaurant_owner']), menuItemController.updateMenuItem);

// Delete an item (restaurant_owner or admin)
router.delete('/:itemId', roleMiddleware(['admin','restaurant_owner']), menuItemController.deleteMenuItem);
